...
import { DashboardInsight } from '../../utils/dashboardInsights';
  ...
  >
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <ul style={{ listStyle: 'none', padding: 0, fontSize: '0.875rem', lineHeight: 1.6, display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
